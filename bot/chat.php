...
$questions = [
    ...
    "informacion" => "centro especializado en Acupuntura-naturopatia y geriatría. diplomados profesionales en salud alternativa",
    "información" => "centro especializado en Acupuntura-naturopatia y geriatría. diplomados profesionales en salud alternativa",
    "que es?" => "centro especializado en Acupuntura-naturopatia y geriatría. diplomados profesionales en salud alternativa",
    "que és?" => "centro especializado en Acupuntura-naturopatia y geriatría. diplomados profesionales en salud alternativa",
    ...
    "¿como estas?" =>"muy bien, pasando un excelente dia, espero que el tuyo tambien.",
    "¿Te pueded dar covid?" =>"jaja, a los bots no nos da coronavirus :).",
    "Te pueded dar covid?" =>"jaja, a los bots no nos da coronavirus :).",
    "¿Tienes covid?" =>"jaja, a los bots no nos da coronavirus :).",
    "Tienes covid?" =>"jaja, a los bots no nos da coronavirus :).",
    "¿Te pueded dar coronavirus?" =>"jaja, a los bots no nos da coronavirus :).",
    "Te pueded dar coronavirus?" =>"jaja, a los bots no nos da coronavirus :).",
    ...
    "¿A qué hora puedo llegar?"=>"De lunes a viernes de 10:00 - 20:00 horas",
    "A qué hora puedo llegar?"=>"De lunes a viernes de 10:00 - 20:00 horas",
    "A qué hora puedo llegar"=>"De lunes a viernes de 10:00 - 20:00 horas",
